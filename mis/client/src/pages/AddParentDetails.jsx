...
import Wrapper from '../assets/wrappers/RegisterAndLoginPage'; // Import Wrapper from the first snippet
...
const AddParentDetails = () => {
  ...
  return (
    <Wrapper> {/* Use Wrapper component */}
      <StyledForm onSubmit={handleSubmit}> {/* Use StyledForm component */}
